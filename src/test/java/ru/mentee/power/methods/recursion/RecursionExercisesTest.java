...
public class RecursionExercisesTest {
        ...
        public void testFibonacciOptimized() {
            assertThat(RecursionExercises.fibonacciOptimized(0, new long[1])).isEqualTo(0);
            assertThat(RecursionExercises.fibonacciOptimized(1, new long[2])).isEqualTo(1);
            assertThat(RecursionExercises.fibonacciOptimized(2, new long[3])).isEqualTo(1);
            assertThat(RecursionExercises.fibonacciOptimized(3, new long[4])).isEqualTo(2);
            assertThat(RecursionExercises.fibonacciOptimized(4, new long[5])).isEqualTo(3);
            assertThat(RecursionExercises.fibonacciOptimized(5, new long[6])).isEqualTo(5);
            assertThat(RecursionExercises.fibonacciOptimized(6, new long[7])).isEqualTo(8);
            assertThat(RecursionExercises.fibonacciOptimized(10, new long[11])).isEqualTo(55);

            assertThat(RecursionExercises.fibonacciOptimized(20, new long[21])).isEqualTo(6765);
            assertThat(RecursionExercises.fibonacciOptimized(30, new long[31])).isEqualTo(832040);

            assertThat(RecursionExercises.fibonacciOptimized(-10, new long[1])).isEqualTo(-1);
